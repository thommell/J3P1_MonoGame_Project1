...
public class LevelSelectionScene : Scene
{
    ...
    {
        //Level Buttons
        objects.Add(new SelectionScreenButton(game, manager, pContent.Load<Texture2D>("UI_Tile_64x64"), "Level 1", manager.GetScene<TestScene>(), pContent.Load<Texture2D>("Lock"))
        {
